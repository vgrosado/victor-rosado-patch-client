      ...
      <body className="landingpage">
        ...
        <div className="landingpage__hero">
          <div className="landingpage__hero-overlay">
            <div className="landingpage__hero-overlaycontents">
              ...
              <Link className="landingpage__signup-link" to={"/SignUp"}>
                <button className="landingpage__hero-signup">
                  Create a free account
                </button>
              </Link>
              <Link className="landingpage__cwa-link" to={"/Discover"}>
                <p className="landingpage__hero-cwa">
        ...
        <section className="landingpage__desc-section">
          <article className="landingpage__cta-div">
            <h1 className="landingpage__desc-header">
              Artist. Booking.{" "}
              <span className="landingpage__desc-span">Revolutionized.</span>
            </h1>
            <p className="landingpage__desc-summary">
              Independant artist's face challenges in showcasing their talent,
              gaining exposure, and securing bookings. There's a clear demand
              for an online platform that eliminates intermediaries, empowers
              artists in negotiations, and simplifies the booking process. Patch
              offers a platform for agents, labels, and anyone seeking talent to
              easily discover and connect with our users.
            </p>
          </article>
          ...
          <article className="landingpage__desc">
            ...
            <div className="landingpage__desc-textdiv">
              <p className="landingpage__desc-text">
                Streamline your artist booking process and connect with talented
                performers effortlessly.
              </p>
          ...
          <article className="landingpage__desc">
            ...
            <div className="landingpage__desc-textdiv">
              ...
              <p className="landingpage__desc-text">
                Explore dynamic artist profiles showcasing user stats, music,
                reviews and more.
              </p>
            </div>
          </article>
          <div className="landingpage__footer">
            <div className="landingpage__footericon-div">
              <Link to="https://www.linkedin.com/in/vgrosado/">
                <FaLinkedin fill="grey" size={25} />
              </Link>
              <Link to="https://github.com/vgrosado">
                <FaGithub fill="grey" size={25} />
              </Link>
            </div>
            <p className="landingpage__footer-text">
              Developed & Designed by: Victor Rosado
            </p>
          </div>
        </section>
      </body>
