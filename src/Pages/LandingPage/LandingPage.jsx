      ...
      <section className="landingpage__desc-section">
        <article className="landingpage__cta-div">
          ...
          <p className="landingpage__desc-summary">
            ...
            gaining exposure, and securing bookings. There's a clear demand for
            an online platform that eliminates intermediaries, empowers artists
            in negotiations, and simplifies the booking process. Patch offers a
            platform for agents, labels, and anyone seeking talent to easily
            discover and connect with our users.
          </p>
        </article>
