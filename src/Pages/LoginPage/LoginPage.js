			...
			<h1 className='login__header'>PATCH</h1>
                <form className="login__form">
					<div className='login__input-div'>
                    	<input className="login__input" type="text" id="username" placeholder='Username'></input>
					</div>
					<div className='login__input-div'>
                    	<input className="login__input" type="password" id="password" placeholder='Password'></input>
						<div className='login__icon'><AiFillEye /></div>
					</div>
					<div className='login__rememberme-div'>
						<input className='login__remember-me' type='checkbox' id='remember-me'></input>
