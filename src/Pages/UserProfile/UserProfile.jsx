...
function UserProfile({
  ...
  async function getUserMusic() {
    const userMusicData = await getDocs(
      collection(db, "users", `${id}`, "Music"),
    );
        ...
        <section className="user">
          <div className="user__background-container">
            {!user?.backgroundimg ? (
              ...
              <img
                className="user__header-background"
            ...
            <div className="user__info-container">
              <div className="user__avatar-div">
                {!currentUser?.photoURL ? (
                  <div className="user__avatar-empty">
                    <img
                      ...
                      alt="dj"
                      src="https://source.boringavatars.com/beam/120/Maria%20Mitchell?colors=ff7b00,191919,ffffff?square"
                    />
                  </div>
                ) : (
                  <img
                ...
                <div className="user__banner-div">
                  <h2 className="user__banner">{user?.displayName}</h2>
                </div>
              </div>
            </div>
          </div>
          <article className="user__stats-container">
            <div className="user__details-container">
              <div className="user__info-div">
                ...
                <div className="user__button-div">
                  <Link
                    className="user__button-link"
                    to={`/EditProfile/${currentUser?.uid}`}
                  >
                    <button className="user__button">
                      Edit Profile
                      <SlPencil className="user__edit-icon" size={12} />
                    </button>
                  </Link>
                </div>
              </div>
            ...
            {user?.genre === "" ? (
              ...
              <div className="user__genre-div">
                ...
                <p className="user__genre">
                  {user?.genre === null ? "Add a genre" : user?.genre}
                </p>
              </div>
            )}
            <div className="user__contacts-container">
              ...
              <div className="user__website-div">
                ...
                {user?.website === null ? (
                  <p className="user__website">Add a website</p>
                ) : (
                  <Link to={user?.website} className="user__website">
                    {user?.website === null
                      ? "Add your website"
                      : user?.website}
                  </Link>
            ...
            <div className="user__nav-div">
              <p
                onClick={handleNavToMusic}
                className={
                  musicPage && !encorePage && !bookingPage
              ...
              <p
                onClick={handleNavToEncore}
                className={
                  encorePage && !bookingPage && !musicPage
                    ? "user__nav-item-active"
                    : "user__nav-item"
                }
              >
              ...
              <p
                ...
                className={
                  bookingPage && !encorePage && !musicPage
                    ? "user__nav-item-active"
                    : "user__nav-item"
                }
              >
          ...
          <article className="user__stats-container">
            <div className="user__details-container">
              <div className="user__info-div">
                <h2 className="user__heading">About</h2>
                <div className="user__button-div">
                  <button className="user__button" onClick={handleNavToBooking}>
                    + Book
                  </button>
                </div>
              </div>
